...
const path1 = puzzle[0].split(',')
const path2 = puzzle[1].split(',')

const demo1 = 'R98,U47,R26,D63,R33,U87,L62,D20,R33,U53,R51'.split(',');
const demo2 = 'U98,R91,D20,R16,D67,R40,U7,R15,U6,R7'.split(',');
...
const part1 = (path1, path2) => {

	const wirepath1 = wirepath(path1);
	const wirepath2 = wirepath(path2);

	const intersection = wirepath1.filter(value => wirepath2.includes(value))

	const distance = intersection.map(e => { 
		const a = e.split(',');
		return Math.abs(a[0]) + Math.abs(a[1]) 
	}).splice(1).sort(function(a, b){return a-b} )[0];
...
const part2 = (path1, path2) => {
	...
	const intersection = wirepath2.filter(value => wirepath1.includes(value))

	const distance = intersection.map(e => { return wirepath1.indexOf(e) + wirepath2.indexOf(e) } )
	.sort(function(a, b){return a-b} )[0];

	return distance
}

// console.log(part1(path1, path2))
console.log(part2(path1, path2))